export default {
  ...
  create: {
    ...
    Skins: 'Any skin',
    yourMoneyCountHere: 'Any amount, any coins (optional)',
    yourMessageHere: 'Your message here (optional)',
    yourPasswordHere: 'Your password here (optional)',
    plzFill: 'Please send any Minter coins to this address',
    plzFillPart1: 'Please send',
    plzFillPart2: 'coins to this address',
    minBalanceCoin: '',
